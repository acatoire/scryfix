...
3.1. - [x] Wizard Upload the correct card image is required for now, add the possibility to put it optional and
           the report will be special as not complete the community will be able to complete it later.
...
Phase 1 stays focused on proving the single `missing_image_language` path end to end, including a real deployment.
