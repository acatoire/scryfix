...
5. **👍/comment flow for existing reports** — lets users confirm or bump a report they find instead of filing a new one,
   per §4.4.
6. **Multi-card wizard**: report the same underlying issue across several cards/languages in one go — e.g. "5 language
